...
import { Volume2, Search, X, Check, Play } from 'lucide-react';
        ...
        <div className="px-6 py-4 border-b border-slate-800 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">{t('sound_modal.subtitle')}</p>
            </div>
          </div>
        ...
        <div className="p-4 bg-slate-950/60 border-b border-slate-800 space-y-3">
          <div className="relative">
            ...
            <input
              ...
              placeholder={t('sound_modal.search_placeholder')}
          ...
          <div className="flex flex-wrap gap-1.5">
            {categories.map((cat) => (
              ...
              >
                {cat === 'ALL' ? t('sound_modal.cat_all') : cat}
              </button>
            ))}
          </div>
        </div>
              ...
              >
                ...
                <div className="flex items-center justify-between pt-1 border-t border-slate-900">
                  ...
                  >
                    ...
                    <span>{t('sound_modal.btn_preview')}</span>
                  </button>
                  ...
                  >
                    ...
                    <span>{t('sound_modal.btn_select')}</span>
                  </button>
                </div>
              </div>
            ))
